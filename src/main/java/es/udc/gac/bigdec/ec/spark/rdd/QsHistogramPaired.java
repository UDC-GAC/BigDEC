...
public class QsHistogramPaired implements FlatMapFunction<Iterator<Tuple2<Sequence,Sequence>>,int[]>{

	private static final long serialVersionUID = -8596937041199264773L;
